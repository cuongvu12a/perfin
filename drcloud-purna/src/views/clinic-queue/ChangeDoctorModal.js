...
const ChangeDoctorModal = ({ appointmentInfo, handleError403, close }) => {
  ...
  const handleSpecialtyChanged = value => {
    ...
    if (value) {
      ...
      setDoctor(appointmentInfo.doctorId)
    }
  }
        ...
        <Form>
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={!isAllowedSubmit || doctor === appointmentInfo.doctorId}
            >
